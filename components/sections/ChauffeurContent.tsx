  ...
  return (
    <main className="flex-1">
        ...
        <section className="py-24 bg-white">
          <div className="container mx-auto px-4 max-w-5xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold text-gray-900 tracking-tight">{requirements.title}</h2>
              <p className="text-xl text-gray-600 mt-4">{requirements.subtitle}</p>
            </div>
        ...
        <section className="py-24 bg-gray-50">
          <div className="container mx-auto px-4 max-w-5xl">
            <h2 className="text-3xl md:text-5xl font-bold text-center text-gray-900 tracking-tight mb-16">{steps.title}</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {steps.items.map((s, i) => (
                <div key={i} className="relative p-8 bg-white rounded-3xl border border-gray-100 shadow-sm">
